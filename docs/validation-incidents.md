...
| # | Incident | Agent/tooling surface | Suspected changed state | Gandalf classification | Source |
|---:|---|---|---|---|---|
...
| remote | 0 | Network/auth failures are recorded as unsupported in v0.1 because Gandalf does not perform live auth/network probes. |
