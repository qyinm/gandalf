...
export function buildReadinessReport(
  ...
  if (targetPlatform !== "darwin") {
    items.push({
      ...
      code: "SNAPTAILOR_MACOS_APPLY_ONLY",
  ...
  for (const key of [...sourceEnvKeys].sort()) {
    ...
    items.push({
      ...
      severity: "medium",
      code: "SNAPTAILOR_ENV_VALUE_REQUIRED",
...
export function readinessItemForMcpReport(report: McpBinaryReport): ReadinessItem {
  if (report.binaryKind === "remote_url") {
    return {
      ...
      category: "unverified",
      severity: "low",
      code: "SNAPTAILOR_REMOTE_MCP_UNVERIFIED",
      ...
      fix: "Verify the remote endpoint outside snaptailor if this MCP server is required.",
  ...
  if (report.availableOnTarget) {
    return {
      ...
      category: "ready",
      severity: "none",
      code: "SNAPTAILOR_MCP_COMMAND_AVAILABLE",
  ...
  if (report.binaryKind === "source_local_path") {
    return {
      ...
      category: "needs_manual_action",
      severity: "medium",
      code: "SNAPTAILOR_SOURCE_LOCAL_MCP_PATH",
  ...
  return {
    ...
    category: "needs_manual_action",
    severity: "medium",
    code: "SNAPTAILOR_MCP_COMMAND_MISSING",
