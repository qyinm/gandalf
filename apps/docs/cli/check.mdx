...
sidebarTitle: "check"
description: "Compare gandalf.toml against local Codex and Claude Code setup and report missing MCP servers, skills, or hooks. Add --ci to exit non-zero on drift."
---
